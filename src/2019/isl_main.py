...
# 2019 draft 2018 SOTS script ids used (periodically updated)
draft_ids_2018sots = [5117, 2033, 1005, 5101, 7015]
...
for rec in mm_dict:
    ...
    if (rec['Request Group'] != "2018 SOTS") or (rec['Request Group'] == "2018 SOTS" and rec['input_id'] in draft_ids_2018sots):
        # error handling
