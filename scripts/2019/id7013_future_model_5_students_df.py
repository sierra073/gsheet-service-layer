...
cost_insights2 = pd.read_csv(GITHUB+'''data/id5002_cost_projections_2016_2025.csv')
...
df_circuit_pricing.to_csv(GITHUB+'/''data/'+os.path.basename(__file__).replace('.py','.csv'),index=False)
