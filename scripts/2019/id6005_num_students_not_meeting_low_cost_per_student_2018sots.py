...
bandwidth_over_time = getData( myConnection, 'num_students_meeting_not_meeting_by_reason_affordability_2018sots.sql')
...
print(round(bandwidth_over_time[bandwidth_over_time.subgroup == 'increase budget'].num_students.reset_index(drop=True)[0],-5))