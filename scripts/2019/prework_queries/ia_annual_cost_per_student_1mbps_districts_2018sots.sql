...
select district_id, size,
   (ia_annual_cost_total - ia_funding_requested_erate) as oop_cost,
   num_students,
   (ia_annual_cost_total - ia_funding_requested_erate)/num_students as ia_annual_cost_per_student
  from subset
