...
final_before_cost as (
	...
	select 
	2019 as funding_year,
	f.upgrade_group,
	f.districts_upgrade_extrap as districts,
	f.students_upgrade_extrap as students,
	districts_pop,
	students_pop
...
union 
	...
	select 
	2019 as funding_year,
	'currently_meeting' as group,
	districts_meeting_before_extrap as districts,
	students_meeting_before_extrap as students,
	districts_pop,
	students_pop

	from final_before_cost f 

	group by districts_meeting_before_extrap,
	students_meeting_before_extrap,
	districts_pop,
	students_pop

union 

	select 2019 as funding_year,
	f.upgrade_group,
	0 as districts,
	0 as students,
	districts_pop,
