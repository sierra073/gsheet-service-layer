...
select 'Need to Spend More' as subgroup,
median(ia_annual_cost_oop_per_student) as median_ia_annual_cost_per_student
from grp
group by 1
...
select 
    ...
    median((ia_annual_cost_total - ia_funding_requested_erate)/num_students) as median_ia_annual_cost_per_student
  from subset
