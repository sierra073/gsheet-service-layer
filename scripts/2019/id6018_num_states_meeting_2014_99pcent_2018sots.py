...
Question: XX States have connected 99% of total students
Output:
1. Number of states that have connected 99% of students
2. State code of states that have connected 99% of students
'''
...
s1_100k = df_meeting_100k_2018.groupby('state_code').num_students.sum()
s2_100k = df_meeting_100k_2018.groupby('state_code').district_id.nunique()
...
num_states_99 = df_results[df_results.pcent_students_meeting_2014_fy2019 >= 0.99].shape[0]
print(str(num_states_99))
