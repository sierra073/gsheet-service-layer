...
SELECT --ucs.state_code,
      ...
      ucs.ak_sum_unscalable_campuses AS unscalable_campuses_ak, --(147)
      ucs.nat_sum_unscalable_campuses_no_ak * fob.hybrid_pct_fiber_on_block AS fiber_on_block_campuses, --(310)
      ucs.nat_sum_unscalable_campuses_no_ak * (1 - fob.hybrid_pct_fiber_on_block) AS needs_build_campuses, --(900)

      --Second Layer of Funnel (State Match)
      ucs.nat_sum_unscalable_campuses_no_ak * (1 - fob.hybrid_pct_fiber_on_block)
      * bcc.state_match_needs_build AS state_match_campuses, --(658)
      ucs.nat_sum_unscalable_campuses_no_ak * (1 - fob.hybrid_pct_fiber_on_block)
      * (1 - bcc.state_match_needs_build) AS no_match_campuses, --(242)

      --Third Layer of Funnel (build costs)
      ucs.nat_sum_unscalable_campuses_no_ak * (1 - fob.hybrid_pct_fiber_on_block)
      * bcc.state_full_match_needs_build
      AS state_full_match_campuses, --(105) IL,MO,WA state give free builds to all campuses
      ucs.nat_sum_unscalable_campuses_no_ak * (1 - fob.hybrid_pct_fiber_on_block)
      * bcc.free_state_match_needs_build AS free_state_match_campuses,--(354)
      ucs.nat_sum_unscalable_campuses_no_ak * (1 - fob.hybrid_pct_fiber_on_block)
      * bcc.low_cost_state_match_needs_build AS low_cost_state_match_campuses, --(45)
      ucs.nat_sum_unscalable_campuses_no_ak * (1 - fob.hybrid_pct_fiber_on_block)
      * bcc.high_cost_state_match_needs_build AS high_cost_state_match_campuses, --(154)
      ucs.nat_sum_unscalable_campuses_no_ak * (1 - fob.hybrid_pct_fiber_on_block)
      * bcc.low_cost_no_match_needs_build AS low_cost_no_match_campuses,--(2)
      ucs.nat_sum_unscalable_campuses_no_ak * (1 - fob.hybrid_pct_fiber_on_block)
      * bcc.high_cost_no_match_needs_build AS high_cost_no_match_campuses, --(240)
