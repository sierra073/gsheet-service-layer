...
# Of districts that met 100kbps by 2015, XX% upgraded at least once since meeting 100k.
df_2015 = df_results[df_results.year_first_meet2014 == 2015]
num_d_2015 = df_2015.district_id.nunique()
num_c2015_upgrading = df_2015[df_2015.years_to_upgrade_after_meeting100 != 0].district_id.nunique()
print(num_c2015_upgrading/num_d_2015)
