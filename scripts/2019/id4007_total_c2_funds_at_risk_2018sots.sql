...
select 
	   funding_year,
       sum(remaining_post) as c2_funds_at_risk_expiring_in_2019
...
select 
	   funding_year,
       sum(remaining_post) as c2_funds_at_risk_for_0_year_districts
...
select b.c2_funds_at_risk_for_0_year_districts + a.c2_funds_at_risk_expiring_in_2019 as total_funds_at_risk
