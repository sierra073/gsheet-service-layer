...
write.csv(med_pct,file=paste(ghub,'/''data/id3003_yoy_price_pct.csv',sep=''),row.names=FALSE)
...
#write.csv(deltaframe[,1:5],file='~/GitHub/ficher/''data/yoy_bw_deltas.csv',row.names=T)
