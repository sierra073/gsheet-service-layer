...
write.csv(med_pct,file=paste(ghub,'/Projects/sots-isl/data/id3003_yoy_price_pct.csv',sep=''),row.names=FALSE)
...
#write.csv(deltaframe[,1:5],file='~/GitHub/ficher/Projects/sots-isl/data/yoy_bw_deltas.csv',row.names=T)
