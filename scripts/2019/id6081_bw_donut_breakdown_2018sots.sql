...
states as (
  SELECT
        ...
        SUM(CASE 
              ...
              ELSE 0 
            END) as pct_100kbps_2015,
        SUM(CASE 
              WHEN funding_year = 2017
                then connectivity_schools
              ELSE 0 
            END) as pct_100kbps_2017,
        SUM(CASE 
              WHEN funding_year = 2018
                then connectivity_schools
              ELSE 0 
            END) as pct_100kbps_2018,
        SUM(CASE 
              WHEN funding_year = 2019
                then connectivity_schools
              ELSE 0 
            END) as pct_100kbps_2019
  FROM states_prepre
...
select *
from states
where pct_100kbps_2019 >= .99
or pct_100kbps_2018 >= .99
or pct_100kbps_2017 >= .99
or pct_100kbps_2015 >= .99
order by 
  pct_100kbps_2015 >= .99 desc,
  pct_100kbps_2017 >= .99 desc,
  pct_100kbps_2018 >= .99 desc,
  pct_100kbps_2019 >= .99 desc,
  pct_100kbps_2019 desc,
  pct_100kbps_2018 desc,
  pct_100kbps_2017 desc,
  pct_100kbps_2015 desc,
  state_code
