...
WHERE df.assumed_unscalable_campuses + df.known_unscalable_campuses >
    ...
    AND NOT (df.fiber_target_status = 'Target'
      AND df.known_unscalable_campuses > lydf.known_unscalable_campuses)
    AND NOT(df.assumed_unscalable_campuses > lydf.assumed_unscalable_campuses)
