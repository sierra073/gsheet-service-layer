...
pay_more_both_years as (
  SELECT
    pm18.district_id,
    pm18.num_students as students_18,
    pm19.num_students as students_19,
...
median(pay_more_amount_18/students_18) as median_inc_needed_per_student_18,
median((pay_more_amount_18/students_18)*(1-c1_discount_rate_ia)) as median_oop_inc_needed_per_student_18,
median(pay_more_amount_19/students_19) as median_inc_needed_per_student_19,
median((pay_more_amount_19/students_19)*(1-c1_discount_rate_ia)) as median_oop_inc_needed_per_student_19
