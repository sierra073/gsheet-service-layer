...
plt.scatter(students_1mbps[students_1mbps.funding_year < 2019].funding_year,
            students_1mbps[students_1mbps.funding_year < 2019].num_students,
...
for i in range(students_1mbps.funding_year.min(),students_1mbps.funding_year.max()):
    ax.text(i-.05, students_1mbps[students_1mbps.funding_year == i].num_students+1,
            str(round(students_1mbps[students_1mbps.funding_year == i].reset_index().num_students[0],1))+'M',
...
ax.text(2019-.09, students_1mbps[students_1mbps.funding_year == 2019].num_students+1,
        str(round(students_1mbps[students_1mbps.funding_year == 2019].reset_index().num_students[0],1))+'M',
        color="#f26c23", fontproperties=prop,size=14, ha='right')

#adding line
plt.plot(students_1mbps.funding_year, students_1mbps.num_students, color="#636363", zorder=1)
