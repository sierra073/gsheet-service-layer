...
select 
	   funding_year,
       count(distinct district_id) as districts_with_c2_funds_at_risk_expiring_in_2019
...
select 
	   funding_year,
       count(distinct district_id) as districts_with_c2_funds_at_risk_for_0_year_districts

from agg100percenter

group by funding_year)


select b.districts_with_c2_funds_at_risk_for_0_year_districts + a.districts_with_c2_funds_at_risk_expiring_in_2019 as total_funds_at_risk

from the2014ers a

join the100percenters b
on a.funding_year = b.funding_year 
