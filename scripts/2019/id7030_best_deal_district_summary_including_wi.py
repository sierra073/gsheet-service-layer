...
not_meeting_extrap = get_data(GITHUB+'/Projects/sots-isl/scripts/2019/prework_queries/id7030_extrap_not_meeting_including_wi.sql')
wi_districts = get_data(GITHUB+'/Projects/sots-isl/scripts/2019/prework_queries/id7030_best_deals_wi.sql')

all_no_spiya = pd.read_csv(GITHUB+'/Projects/sots-isl/data/id7024_all_districts.csv')
best_deals = pd.read_csv(GITHUB+'/Projects/sots-isl/data/id7024_best_deal_districts.csv')
...
best_deals_including_wi.to_csv(GITHUB+'/Projects/sots-isl/data/id7030_best_deal_districts_including_wi.csv',index=False)
...
all_no_spiya_including_wi.to_csv(GITHUB+'/Projects/sots-isl/data/id7030_all_districts_including_wi.csv',index=False)
