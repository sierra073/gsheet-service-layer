...
Bandwidth Box Infographic -- Text in infographic:
In three years, median bandwidth speeds have increased by 3.9x across Wisconsin-
from 203 kbps to 797 kbps. 2015: 203 kbps, 2019: 797 kbps. (Future, p12)
'''
...
# median bandwidth per student meeting 2019 goal from 2015-2019
s1 = df_filtered_ia.groupby(['state_code', 'funding_year'])['ia_bandwidth_per_student_kbps'].median()
