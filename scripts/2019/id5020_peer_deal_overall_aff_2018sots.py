...
x = pd.crosstab(df['had_peer_deal'], df.dec_cost_more_bw).apply(lambda r: r / r.sum(), axis=1).reset_index()
x.columns = ['had_peer_deal', 'no_cost_decrease', 'cost_decrease']
...
plt.savefig('id5020_peer_deal_overall_aff_2018sots.png')
