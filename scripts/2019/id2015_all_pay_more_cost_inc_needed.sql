with pay_more_2018 as (
      ...
      median(path_to_meet_2018_goal_monthly_cost_needed/ia_monthly_cost_total) as median_perc_cost_inc_needed,
      median(path_to_meet_2018_goal_monthly_cost_needed*(1-c1_discount_rate_ia)) as median_oop_cost_inc_needed
