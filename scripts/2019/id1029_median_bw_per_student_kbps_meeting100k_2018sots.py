...
df_meeting100k = df_filtered_ia[(df_filtered_ia.meeting_2014_goal_no_oversub == True)]
s1 = df_meeting100k.groupby('funding_year')['ia_bandwidth_per_student_kbps'].median()
...
df_results.to_csv('id1029_median_bw_per_student_kbps_meeting100k_2018sots.csv', index=False)
