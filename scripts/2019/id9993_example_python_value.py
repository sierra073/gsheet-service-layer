...
myConnection = psycopg2.connect( host=HOST_DAR, user=USER_DAR, password=PASSWORD_DAR, database=DB_DAR)

#pull bandwidths from DB
bandwidth_over_time = getData( myConnection, 'id9993_example_python_value.sql')
...
print(round(bandwidth_over_time[bandwidth_over_time.subgroup == 'not looking to upgrade'].num_students.reset_index(drop=True)[0],-5))
