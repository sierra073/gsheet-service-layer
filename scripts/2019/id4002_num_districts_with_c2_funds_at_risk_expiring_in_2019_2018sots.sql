...
-- more than 50% of funds need to remain for them to be considered as having at risk funds
...
select count(district_id) as num_districts_with_c2_funds_at_risk_expiring_in_2019
from agg
