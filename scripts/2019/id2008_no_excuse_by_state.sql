...
count(distinct am.district_id)::numeric/count(distinct d.district_id)::numeric as "% of State",
count(distinct am.district_id)::numeric/count(distinct db.district_id) filter(where fit.fit_for_ia = true)::numeric as "% of Not Meeting"
...
left join ps.districts_bw_cost db
on d.district_id = db.district_id
and db.funding_year = 2019
